 ...
 */
export declare function getAccessibilityTree(page: StagehandPage, logger: (logLine: LogLine) => void, selector?: string): Promise<TreeResult>;
 ...
 */
export declare function resolveObjectIdForXPath(page: StagehandPage, xpath: string): Promise<string | null>;
